...
case FF_OP_S_STORE:
    ...
    _FF_CHECK_ADDR((const void *)(intptr_t)_FF_NOS, 1);
    {
        size_t _n = strlen((const char *)(intptr_t)_FF_NOS) + 1;
        _FF_CHECK_ADDR((const void *)(intptr_t)_FF_NOS, _n);
        _FF_CHECK_ADDR((const void *)(intptr_t)tos, _n);
        memcpy((char *)(intptr_t)tos, (const char *)(intptr_t)_FF_NOS, _n);
    }
    _FF_DROPN(2);
    _FF_NEXT();
...
case FF_OP_S_CAT:
    ...
    _FF_CHECK_ADDR((const void *)(intptr_t)tos, 1);
    {
        ...
        _FF_CHECK_ADDR((const void *)(intptr_t)_FF_NOS, _src_n + 1);
